...
/opt/anaconda3/bin/conda create --yes --name py3.8-tf2 python=3.8 numpy scipy matplotlib pandas seaborn tensorflow statsmodels ipykernel ipympl nodejs jupyterlab
/opt/anaconda3/envs/py3.8-tf2/bin/python -m ipykernel install --name 'py3.8-tf2' --display-name "py3.8-tf2"
...
/opt/anaconda3/envs/py3.8-tf2/bin/jupyter labextension install --no-build @jupyter-widgets/jupyterlab-manager
/opt/anaconda3/envs/py3.8-tf2/bin/jupyter labextension install --no-build jupyter-matplotlib
